...
import { Store, config } from '@workspacecord/core';
import { getAllSessions, endSession, getSessionsByCategory } from '@workspacecord/engine/session-registry';
import { getProject, setHistoryChannelId } from '@workspacecord/engine/project-manager';
import type { ThreadSession, ArchivedSession } from '@workspacecord/core';
